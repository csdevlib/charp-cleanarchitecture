...
using Cleanarch.Application.Common.Utility;
using Cleanarch.Application.Services.Interface;
using Cleanarch.Web.ViewModels;

namespace Cleanarch.Application.Services.Implementation
{
